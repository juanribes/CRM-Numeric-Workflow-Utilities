...
namespace LAT.WorkflowUtilities.Numeric.Tests
{
    ...
    public class ToDecimalTests
    {
        ...
        public ToDecimalTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.Numeric.ToDecimal" + ", " + "LAT.WorkflowUtilities.Numeric";
        }
        #endregion
