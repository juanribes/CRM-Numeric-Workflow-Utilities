...
namespace LAT.WorkflowUtilities.Numeric.Tests
{
    ...
    public class MultiplyTests
    {
        ...
        public MultiplyTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.Numeric.Multiply" + ", " + "LAT.WorkflowUtilities.Numeric";
        }
        #endregion
        ...
        public void MultiplyPlusOne()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["Product"]);
        }

        [TestMethod]
        public void MultiplyPlusFive()
        {
            //Target
            Entity targetEntity = null;
        ...
        [TestMethod]
        public void MultiplyFivePointFive()
        {
            //Target
            Entity targetEntity = null;
        ...
        [TestMethod]
        public void MultiplyMinusFivePointFive()
        {
            //Target
            Entity targetEntity = null;
        ...
        [TestMethod]
        public void MultiplyMinusFivePointFiveFiveFiveRoundTwo()
        {
            //Target
            Entity targetEntity = null;
