...
namespace LAT.WorkflowUtilities.Numeric.Tests
{
    ...
    public class SubtractTests
    {
        ...
        public SubtractTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.Numeric.Subtract" + ", " + "LAT.WorkflowUtilities.Numeric";
        }
        #endregion
        ...
        public void SubtractPlusOne()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["Difference"]);
        }

        [TestMethod]
        public void SubtractPlusFive()
        {
            //Target
            Entity targetEntity = null;
        ...
        [TestMethod]
        public void SubtractFivePointFive()
        {
            //Target
            Entity targetEntity = null;
        ...
        [TestMethod]
        public void SubtractMinusFivePointFive()
        {
            //Target
            Entity targetEntity = null;
        ...
        [TestMethod]
        public void SubtractMinusFivePointFiveFiveFiveRoundTwo()
        {
            //Target
            Entity targetEntity = null;
